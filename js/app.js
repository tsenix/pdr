(() => {
    ...
    function initSliders() {
        ...
        if (document.querySelector(".price__slider")) new Swiper(".price__slider", {
            modules: [ Pagination ],
            observer: true,
            observeParents: true,
            speed: 800,
        ...
        if (document.querySelector(".example__slider")) new Swiper(".example__slider", {
        ...
        if (document.querySelector(".feedbacks__slider")) new Swiper(".feedbacks__slider", {
            ...
            navigation: {
                nextEl: ".feedbacks__arrow-next",
                prevEl: ".feedbacks__arrow-prev"
            },
            breakpoints: {
                320: {
                    slidesPerView: "auto",
...
***************************************************************************** */
    ...
    links.forEach((link => {
        link.addEventListener("click", (function(event) {
            ...
            let offsetPosition;
            if (targetId.includes("main")) offsetPosition = elementPosition + window.scrollY - 200; else offsetPosition = elementPosition + window.scrollY - offset;
            window.scrollTo({
                top: offsetPosition,
                behavior: "smooth"
            });
